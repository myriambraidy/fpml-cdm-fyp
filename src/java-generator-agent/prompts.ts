...
Generated Java target is Java 11. Do not use records, text blocks, switch expressions, or APIs unavailable in Java 11.
Prefer Jackson ObjectNode and ArrayNode for milestone 1 CDM JSON.
Do not import or reference classes that are not generated in this project or provided by pom.xml dependencies.
