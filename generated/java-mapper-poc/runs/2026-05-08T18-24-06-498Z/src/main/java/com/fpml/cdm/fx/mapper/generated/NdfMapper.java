...
/**
 * Maps FpML non-deliverable forward fixture (fx-ex07) to CDM NonTransferableProduct.
 * Handles nonDeliverableSettlement and settlement currency.
...
public class NdfMapper {
    ...
    /**
     * Map FpML NDF document to CDM TradableProduct.
    ...
    /**
     * Map FpML NDF document to CDM NonTransferableProduct.
     * @param doc FpML document
    ...
    /**
     * Build complete CDM Trade from FpML NDF document.
