...
Generated: 2026-05-10T14:07:29.432Z
...
- Approved API contract: C:\Users\User\Desktop\fpml-cdm-fyp\generated\java-mapper-poc\runs\2026-05-10T14-07-28-452Z\agent-workspace\approved-cdm-api-contract.json
- Semantic recipes: C:\Users\User\Desktop\fpml-cdm-fyp\generated\java-mapper-poc\runs\2026-05-10T14-07-28-452Z\agent-workspace\semantic-recipes.json
...
- Trade root: cdm.event.common.Trade, builderReady=yes, rule=construct_directly, reason=Approved builder methods exist in the run-specific contract.
- Trade state root: cdm.event.common.TradeState, builderReady=yes, rule=construct_directly, reason=Approved builder methods exist in the run-specific contract.
- Contract details: cdm.event.common.ContractDetails, builderReady=no, rule=parameter_only, reason=Selected class is approved, but no direct approved builder method is available.
- Non-transferable product: cdm.product.template.NonTransferableProduct, builderReady=yes, rule=construct_directly, reason=Approved builder methods exist in the run-specific contract.
- Economic terms: cdm.product.template.EconomicTerms, builderReady=no, rule=parameter_only, reason=Selected class is approved, but no direct approved builder method is available.
- Payout container: cdm.product.template.Payout, builderReady=yes, rule=construct_directly, reason=Approved builder methods exist in the run-specific contract.
- Settlement payout: cdm.product.template.SettlementPayout, builderReady=yes, rule=construct_directly, reason=Approved builder methods exist in the run-specific contract.
- Resolvable price quantity: cdm.product.common.settlement.ResolvablePriceQuantity, builderReady=no, rule=parameter_only, reason=Selected class is approved, but no direct approved builder method is available.
- Price schedule: cdm.observable.asset.PriceSchedule, builderReady=no, rule=parameter_only, reason=Selected class is approved, but no direct approved builder method is available.
- Party reference or party identity: cdm.base.staticdata.party.metafields.ReferenceWithMetaParty, builderReady=no, rule=parameter_only, reason=Selected class is approved, but no direct approved builder method is available.
