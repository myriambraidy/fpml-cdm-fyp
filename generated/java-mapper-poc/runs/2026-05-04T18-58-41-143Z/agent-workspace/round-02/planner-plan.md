...
- `cdm.product.template.SettlementPayout` (Settlement details)
...
6. `cdm.product.common.settlement.SettlementPayout` is not part of CDM Java; `cdm.product.template.SettlementPayout` is used instead
